...
from metadonne.models import Musique as ModelMusique

@registry.register_document
class SearchMusique(Document):
    ...
    def prepare_duree(self, instance):
        return str(instance.duree)
    def prepare_genre(self, instance):
        return " | ".join(instance.genre.values_list('nom',flat = True))
    
    def prepare_musiciens(self, instance):
        return " | ".join(instance.musiciens.values_list('nom',flat = True))